...
namespace BlizzardDatabaseLib {
    namespace Reader {
        ...
        WDC5SectionReader::WDC5SectionReader(std::shared_ptr<Stream::StreamReader> _streamReader, Structures::WDC5Section section, Structures::WDC5Header& _header)
        ...
        std::shared_ptr<char[]> WDC5SectionReader::GetSection()
        {
            if (!IsOpen)
                return nullptr;
        ...
        std::shared_ptr<char[]> WDC5SectionReader::OpenSection()
        {
        ...
        void WDC5SectionReader::CloseSection()
        {
