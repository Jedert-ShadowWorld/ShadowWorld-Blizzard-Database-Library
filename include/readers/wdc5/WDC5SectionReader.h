...
namespace BlizzardDatabaseLib {
    namespace Reader {
        ...
        class WDC5SectionReader
        {
        public:
            bool IsOpen = false;
            Structures::WDC5Section Section;
        ...
        private:
            ...
            Structures::WDC5Header& _header;
            std::shared_ptr<Stream::StreamReader> _streamReader;
            std::shared_ptr<char[]> _sectionDataBlock;
        public:
            WDC5SectionReader(std::shared_ptr<Stream::StreamReader> _streamReader, Structures::WDC5Section section, Structures::WDC5Header& _header);
